data merge entity @e[type=block_display,limit=1,tag=FTWW_random_hunter_lever] {start_interpolation:0,interpolation_duration:5,transformation:{translation:[-0.2f,0.1f,0.025f]}}
